...
<form action="cadastro.php" method="POST" class="signup-form" id="signupForm">
        ...
        <div class="terms-checkbox">
          ...
          <label for="terms">
            Eu concordo com os <a href="#" target="_blank">Termos de Uso</a> e 
      ...
      <div class="logo-section">
        ...
        <ul class="features-list">
          <li>
            ...
            <span>Acesso a milhares de cursos</span>
          </li>
          <li>
          ...
          <li>
            ...
            <span>Comunidade de aprendizado</span>
          </li>
          <li>
            <i class="fas fa-mobile-alt"></i>
            <span>Aprenda em qualquer lugar</span>
          </li>
        </ul>
      </div>
    </div>
