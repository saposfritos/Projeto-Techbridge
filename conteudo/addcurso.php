...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($mysqli->connect_errno) {
        ...
        // Inserir no banco
        $stmt = $mysqli->prepare("INSERT INTO cursos (titulo, descricao, categoria, url_imagem, instructor) VALUES (?, ?, ?, ?, ?)");
        $stmt->bind_param("sssss", $titulo, $descricao, $categoria, $url_imagem, $instructor);
